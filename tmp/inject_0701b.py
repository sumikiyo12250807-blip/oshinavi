# -*- coding: utf-8 -*-
"""7/1 発売前新着 第2弾50件を index.html EVENTS 末尾に投入＋NEW_ORDER更新。"""
import re, json, sys, io
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

allnew = json.load(open('tmp/all_new2b_final.json', encoding='utf-8'))
...
open('index.html.bak_0701_newpool2', 'w', encoding='utf-8').write(h)
