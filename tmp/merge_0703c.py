...
base = byid[1934]
members = [byid[1934], byid[1935], byid[1936]]
merged_ids = {1935, 1936}
tks = []
for m in members:
...
json.dump(final, open('tmp/built_0703c_final.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
