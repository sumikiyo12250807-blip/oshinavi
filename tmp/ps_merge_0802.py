...
for lg in sorted(LGNAME):
    p = r'C:\Users\user\oshinavi\tmp\presale_%s.json' % lg
...
open(r'C:\Users\user\oshinavi\tmp\ps_merge_0802.txt', 'w', encoding='utf-8').write('\n'.join(lines))
json.dump(flat, open(r'C:\Users\user\oshinavi\tmp\ps_merge_0802.json', 'w', encoding='utf-8'),
