...
o = io.open('tmp/dup_part_0830b.md', 'w', encoding='utf-8')
o.write('# 2026-08-30 部分一致の仕分け直し（%d件）\n\n' % len(part))
...
json.dump({'same': [{'eid': e, 'it': i} for e, i, _ in same], 'diff': [{'eid': e, 'it': i} for e, i, _ in diff]},
          io.open('tmp/part_reclass_0830.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
