...
merged, seen = [], set()
for p in sorted(glob.glob('tmp/_sw_*_0902.json')):
...
json.dump(fresh, open('tmp/_newfresh_0902.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
json.dump(samename, open('tmp/_newsame_0902.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
print('→ tmp/_newfresh_0902.json / tmp/_newsame_0902.json')
