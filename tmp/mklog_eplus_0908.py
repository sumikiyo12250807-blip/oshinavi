# -*- coding: utf-8 -*-
"""振り分けた55件の一覧を logs/assigned_2026-09-08_eplus.md に残す。
...
BEFORE = load("index.html.bak_0908_eplus")
...
o = io.open("logs/assigned_2026-09-08_eplus.md", "w", encoding="utf-8")
W = o.write
...
o.close()
print("wrote logs/assigned_2026-09-08_eplus.md rows=%d" % len(moved))
