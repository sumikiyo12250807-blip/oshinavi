# -*- coding: utf-8 -*-
"""朝の発売前スイープ（tmp/sweep_presale_0912/*.json の rows＝一覧の全行）を使って、
...
出力: tmp/sweep_presale_0912/pia_days_<lg>.txt（tmp/x0912/true_missing.py にそのまま渡せる形）
使い方: python tmp/window_gap_0912.py
      → python tmp/x0912/true_missing.py tmp/sweep_presale_0912/pia_days_01.txt
"""
import collections
import datetime
import glob
