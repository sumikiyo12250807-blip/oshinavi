...
使い方: python tmp/x0924/assign_newpool_0924.py [--apply]
"""
import collections
import io
import json
...
rep = io.open('tmp/x0926/assign_0926.txt', 'w', encoding='utf-8')
...
sys.stdout.write('report: tmp/x0926/assign_0926.txt\n')
