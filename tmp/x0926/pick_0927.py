...
io.open('tmp/x0926/pick_0927.json', 'w', encoding='utf-8').write(
    json.dumps(rows, ensure_ascii=False, indent=1))
with io.open('tmp/x0926/pick_0927.md', 'w', encoding='utf-8') as f:
    f.write('# 9/27(日)に発売が始まる枠（ジャンル別・夜のX投稿の素材）\n')
