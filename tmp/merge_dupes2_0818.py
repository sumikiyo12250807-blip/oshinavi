...
BUILT = {b['id']: b for b in json.load(io.open('tmp/mergebuilt2_0818.json', encoding='utf-8-sig'))}
DROP = {int(k): v for k, v in json.load(io.open('tmp/mergedrop2_0818.json', encoding='utf-8')).items()}
...
bak = 'index.html.bak_0818_mergedupes2'
