# -*- coding: utf-8 -*-
"""build_pia_entries の出力（tmp/samename2_built_0904.json）を、
既存エントリへ「枠を足す」形で統合する。
...
PATH = "index.html"
BUILT = "tmp/samename2_built_0904.json"
CAND = "tmp/samename2_cand_0904.json"
...
io.open("tmp/merge_samename2_0904.txt", "w", encoding="utf-8").write("\n".join(buf))
...
print("WROTE index.html (backup: index.html.bak_0904_samename2)")
