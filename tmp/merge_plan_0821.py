...
cand = json.load(io.open('tmp/pick_samename_0821.json', encoding='utf-8'))
...
io.open('tmp/merge_plan_0821.json', 'w', encoding='utf-8').write(
    json.dumps(list(plans.values()), ensure_ascii=False, indent=1))
io.open('tmp/merge_unmatched_0821.json', 'w', encoding='utf-8').write(
