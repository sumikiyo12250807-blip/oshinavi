...
if skipped:
    print('\n（9/17 の見出しでないので見ていない: %s）' % ' '.join(f[-10:] for f in skipped))
print('\nNG合計 %d' % bad)
