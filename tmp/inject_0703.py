...
tmp/built_0703_final.json を読み込む。genre:"new" で投入(振り分けは合図待ち)。"""
import re, json, sys, io
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

allnew = json.load(open('tmp/built_0703_final.json', encoding='utf-8'))
...
open('index.html.bak_0703_newpool', 'w', encoding='utf-8').write(h)
