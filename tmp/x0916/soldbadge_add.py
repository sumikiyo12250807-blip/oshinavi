...
売り切れの印付きで足す（2026-09-15夜・push 前の独立の読み直しの「参考」＝16件43カード）。
...
V6 = r'C:\Users\user\AppData\Local\Temp\claude\C--Users-user-oshinavi\9f3148c0-6b8e-4c5b-9f93-e5e96670181f\scratchpad\v6_soldbadge.txt'
CACHE = 'tmp/x0916/sb_cache'
