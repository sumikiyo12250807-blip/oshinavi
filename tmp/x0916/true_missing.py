...
出力: 画面 ＋ tmp/x0916/true_missing_<lg>.json（url・どのエントリに足すか）"""
...
json.dump(out, io.open('tmp/x0916/true_missing_%s.json' % lg, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
