...
使い方: python tmp/x0916/pia_days_list.py <lg>   例: 01=音楽 02=演劇 07=クラシック 06=イベント 03=スポーツ 04 05
...
DAYS = {'2026/9/16': '2026-09-16', '2026/9/17': '2026-09-17', '2026/9/18': '2026-09-18'}
...
io.open('tmp/x0916/pia_days_%s.txt' % LG, 'w', encoding='utf-8').write('\n'.join(out) + '\n')
print('\n'.join(out))
