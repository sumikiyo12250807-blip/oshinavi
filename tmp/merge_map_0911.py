...
merge = json.load(io.open('tmp/merge_0911.json', encoding='utf-8'))
...
json.dump(cands, io.open('tmp/cand_merge_0911.json', 'w', encoding='utf-8'),
          ensure_ascii=False, indent=1)
print('→ tmp/cand_merge_0911.json')
