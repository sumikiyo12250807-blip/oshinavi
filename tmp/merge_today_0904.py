# -*- coding: utf-8 -*-
"""build_pia_entries の出力（tmp/today_merge_built_0904.json）を、
既存エントリへ「枠を足す」形で統合する。
...
PATH = "index.html"
BUILT = "tmp/today_merge_built_0904.json"
CAND = "tmp/today_merge_cand_0904.json"
...
io.open("tmp/merge_today_0904.txt", "w", encoding="utf-8").write("\n".join(buf))
...
print("WROTE index.html (backup: index.html.bak_0904_todaymerge)")
