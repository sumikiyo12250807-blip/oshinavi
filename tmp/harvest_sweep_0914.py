# -*- coding: utf-8 -*-
"""朝のスイープ（2026-09-14）。harvest_sweep_0913.py の日付違い。
...
使い方: python tmp/harvest_sweep_0914.py <フィルタ式> <lg> [<lg> ...]
例:     python tmp/harvest_sweep_0914.py rlsStatus=0102 02 07 06 03 04 05
出力:   tmp/presale_<lg>_<フィルタの数字>_0914.json ＋ 同名の .txt（ログ）
"""
import io
import json
import subprocess
...
summary = []
for lg in lgs:
    out = 'tmp/presale_%s_%s_0914.json' % (lg, tag)
    log = 'tmp/presale_%s_%s_0914.txt' % (lg, tag)
