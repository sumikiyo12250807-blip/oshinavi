...
out = io.open('tmp/deadline_cover_%s_0915.md' % GRP, 'w', encoding='utf-8')
W = out.write
...
out.close()
print('読めた %d件 / 突き合わせた買える枠 %d / 覆う登録が無い枠がある %d件・%d枠 / 逆向きで合わない登録の枠 %d → tmp/deadline_cover_%s_0915.md' % (
