...
todo=json.load(open('tmp/merge_todo_0829.json',encoding='utf-8'))
...
io.open('tmp/merge_in_0829.json','w',encoding='utf-8').write(json.dumps(out,ensure_ascii=False,indent=1))
