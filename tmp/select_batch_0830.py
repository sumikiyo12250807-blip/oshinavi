...
T=datetime.date(2026,8,30)
d=json.load(open('tmp/presale_sweep_0830.json',encoding='utf-8'))
ms=d['missing']
...
json.dump({'cand':cand,'dup':[{'it':a,'why':b} for a,b in dup]},
          open('tmp/batch_cand_0830.json','w',encoding='utf-8'),ensure_ascii=False,indent=1)
