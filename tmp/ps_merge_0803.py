...
open(r'C:\Users\user\oshinavi\tmp\ps_merge_0803.txt', 'w', encoding='utf-8').write('\n'.join(lines))
json.dump(flat, open(r'C:\Users\user\oshinavi\tmp\ps_merge_0803.json', 'w', encoding='utf-8'),
