...
根拠（b＝千葉12/20 千葉LOOK・eventCd=2628298 で「予定枚数終了」tmp/statustext_4500_chiba_tokai_0912.txt）＝ぴあの生HTMLの状態の文字（tools/pia_statustext.py・tmp/statustext_bundle_0912.py の出力）:
