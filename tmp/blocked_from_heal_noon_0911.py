...
log = open('tmp/heal_apply_noon_0911.txt', encoding='utf-8').read()
...
json.dump(out, open('tmp/blocked_built_noon_0911.json', 'w', encoding='utf-8'),
          ensure_ascii=False, indent=1)
print('ブロックされた %d件 → ビルド結果が取れた %d件 → tmp/blocked_built_noon_0911.json'
      % (len(ids), len(out)))
