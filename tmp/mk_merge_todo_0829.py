...
d = json.load(io.open('tmp/batch_cand_0829.json', encoding='utf-8'))
...
io.open('tmp/merge_todo_0829.json', 'w', encoding='utf-8').write(json.dumps(full, ensure_ascii=False, indent=1))
o = io.open('tmp/dup_part_0829.md', 'w', encoding='utf-8')
...
print('部分一致(目視候補): %d件 → tmp/dup_part_0829.md' % len(part))
