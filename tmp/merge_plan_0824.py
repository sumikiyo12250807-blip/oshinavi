...
cand = json.load(io.open('tmp/merge_cand_0824.json', encoding='utf-8'))
...
io.open('tmp/merge_plan_0824.json', 'w', encoding='utf-8').write(
    json.dumps(list(plans.values()), ensure_ascii=False, indent=1))
io.open('tmp/merge_unmatched_0824.json', 'w', encoding='utf-8').write(
...
io.open('tmp/merge_plan_0824.txt', 'w', encoding='utf-8').write('\n'.join(L))
