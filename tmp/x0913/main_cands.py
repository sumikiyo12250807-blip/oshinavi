...
使い方: python tmp/x0913/main_cands.py
出力: tmp/x0913/main_cands.txt
"""
import io
import json
import re
...
io.open('tmp/x0913/main_cands.txt', 'w', encoding='utf-8').write('\n'.join(out) + '\n')
print('→ tmp/x0913/main_cands.txt (%d行)' % len(out))
