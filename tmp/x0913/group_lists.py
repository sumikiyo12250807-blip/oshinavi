...
ALIAS = {
    ...
    # 9/13発売分（9/12夜）
    'ギターと静寂|五十嵐紅《星と祈り》（東京公演）': 'ギターと静寂|五十嵐紅《星と祈り》',
    'ギターと静寂|五十嵐紅《星と祈り》（横浜公演）': 'ギターと静寂|五十嵐紅《星と祈り》',
    '五十嵐紅|ギターと静寂『クリスマス』（静岡公演）': '五十嵐紅|ギターと静寂『クリスマス』',
    '反田恭平&ザルツブルク・モーツァルテウム管弦楽団 日本ツアー2027': '反田恭平&ザルツブルク・モーツァルテウム管弦楽団',
}
...
for f in sorted(glob.glob('tmp/x0913/post*.txt')):
