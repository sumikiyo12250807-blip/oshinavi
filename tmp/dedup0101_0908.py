...
built = json.load(io.open("tmp/built0101_0908.json", encoding="utf-8"))
...
o = io.open("tmp/dedup0101_0908.md", "w", encoding="utf-8")
W = o.write
...
json.dump([c for c in fresh], io.open("tmp/inject0101_fresh.json", "w", encoding="utf-8"),
          ensure_ascii=False, indent=1)
json.dump([c for c, _, _ in addto], io.open("tmp/inject0101_addto.json", "w", encoding="utf-8"),
          ensure_ascii=False, indent=1)
print("built=%d zero=%d fresh=%d addto=%d same=%d -> tmp/dedup0101_0908.md"
