...
PATH = 'index.html'
CACHE = 'tmp/zb_refetch_0824_cache.json'
IDS = [446, 2744, 4043, 4056, 4113, 4118, 4156, 4332]
...
def main():
    ...
    nl = '\r\n' if '\r\n' in src else '\n'
    shutil.copy(PATH, PATH + '.bak_0824_zerobadge')
    ...
    print('書き込み完了（backup: %s.bak_0824_zerobadge）' % PATH)
    return 0
