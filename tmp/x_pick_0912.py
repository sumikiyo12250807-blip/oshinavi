...
o = io.open("tmp/x_material_0912.md", "w", encoding="utf-8")
...
o.close()
print("明日発売 %d枠 / ジャンル %d -> tmp/x_material_0912.md" % (tot, len(rows)))
