...
d = json.load(io.open('tmp/batch_cand_0829b.json', encoding='utf-8'))
cand = d['cand']
...
for k, items in groups.items():
    ...
    nextid += 1
io.open('tmp/build_in_0829b.json', 'w', encoding='utf-8').write(json.dumps(out, ensure_ascii=False, indent=1))
