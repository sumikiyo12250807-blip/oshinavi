...
入力: tmp/merge_plan_0824.json（tmp/merge_plan_0824.py が作る）
出力: tmp/merge_cand_0824.json（build_pia_entries.py にそのまま渡せる形）
"""
import io
import json
import re
...
plans = json.load(open('tmp/merge_plan_0824.json', encoding='utf-8'))
...
io.open('tmp/merge_cand_0824.json', 'w', encoding='utf-8').write(
