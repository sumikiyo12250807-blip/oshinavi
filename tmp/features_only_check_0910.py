...
urls = json.load(io.open('tmp/features_only_urls_0910.json', encoding='utf-8'))
...
json.dump(out, io.open('tmp/features_only_result_0910.json', 'w', encoding='utf-8'),
...
print('→ tmp/features_only_result_0910.json')
