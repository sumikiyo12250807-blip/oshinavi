...
使い方: python tmp/split_built_0915.py <built.json> <cands.json>
出力: tmp/split_built_0915.txt ／ tmp/merge_built_0915.json ／ tmp/merge_cands_0915.json ／ tmp/new_built_0915.json
"""
import io
import json
import re
...
# 出力の名前の札（既定 0915＝今朝の音楽）。発売前など別のバッチは ps0915 のように変えて、前の記録を上書きしない
TAG = sys.argv[3] if len(sys.argv) > 3 else '0915'
