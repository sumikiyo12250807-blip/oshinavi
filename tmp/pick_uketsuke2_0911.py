# -*- coding: utf-8 -*-
"""受付中（rlsStatus=0101）の残りタネから今日のバッチを選ぶ（2026-09-11）。
...
出力: tmp/cand_uk2_0911.json ／ tmp/rest0101_0911b.json（残り）
"""
import collections, io, json, re, sys
sys.stdout.reconfigure(encoding='utf-8')
N = int(sys.argv[1]) if len(sys.argv) > 1 else 100
ORDER = ['01', '02', '07', '06', '03', '04', '05']
rest = json.load(io.open('tmp/rest0101_0911b.json', encoding='utf-8'))
...
json.dump([{'artist': c['artist'], 'urls': [c['url']], 'eventCd': c['eventCd']} for c in pick],
          io.open('tmp/cand_uk2_0911.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
json.dump(left, io.open('tmp/rest0101_0911c.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
