# -*- coding: utf-8 -*-
"""7/3 発売前新着50件を index.html EVENTS 末尾に投入＋NEW_ORDER更新。
tmp/built_0703c_final.json を読み込む。genre:"new" で投入(振り分けは合図待ち)。"""
import re, json, sys, io
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')

allnew = json.load(open('tmp/built_0703c_final.json', encoding='utf-8'))
...
# genre:"new" 強制(振り分け前) & verified付与(表示対象に)
for e in allnew:
    e['genre'] = 'new'
    e.setdefault('verified', True)
...
open('index.html.bak_0703c_newpool', 'w', encoding='utf-8').write(h)
