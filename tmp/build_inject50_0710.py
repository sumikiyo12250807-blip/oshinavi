...
# 1) build
r = subprocess.run([sys.executable, 'tools/build_pia_entries.py', 'tmp/cand50_0710.json'],
...
json.dump(built, open('tmp/built50_0710.json', 'w', encoding='utf-8'), ensure_ascii=False, indent=1)

cand_ids = [c['newid'] for c in json.load(open('tmp/cand50_0710.json', encoding='utf-8'))]
...
open('index.html.bak_0710_newpool', 'w', encoding='utf-8').write(idx)
