...
BUILT = {b['id']: b for b in json.load(io.open('tmp/mergebuilt6_0819.json', encoding='utf-8-sig'))}
DROP = {int(k): v for k, v in json.load(io.open('tmp/mergedrop6_0819.json', encoding='utf-8')).items()}
...
bak = 'index.html.bak_0819_mergedupes6'
