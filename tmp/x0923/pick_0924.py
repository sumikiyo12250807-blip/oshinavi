...
io.open('tmp/x0923/pick_0924.json', 'w', encoding='utf-8').write(
    json.dumps(rows, ensure_ascii=False, indent=1))
with io.open('tmp/x0923/pick_0924.md', 'w', encoding='utf-8') as f:
    f.write('# 9/24(木)に発売が始まる枠（ジャンル別・夜のX投稿の素材）\n')
