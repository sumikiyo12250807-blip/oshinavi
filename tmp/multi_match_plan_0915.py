...
出力: tmp/multi_match_plan_0915.txt
"""
import datetime
import io
import json
...
lines = [l for l in io.open('tmp/split_built_0915.txt', encoding='utf-8').read().splitlines() if l.startswith('👀複数')]
...
io.open('tmp/multi_match_plan_0915.txt', 'w', encoding='utf-8').write('\n'.join(out) + '\n')
print(out[0])
