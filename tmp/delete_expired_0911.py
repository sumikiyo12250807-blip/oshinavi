# -*- coding: utf-8 -*-
"""公演が終わったエントリを index.html から消す（2026-09-11 朝の便）。

DELETE_GATE.md の手順どおり：
  ・別エージェントの独立検証済み（「削除は誤りという前提で」・候補値は見せていない）＝12件とも反証なし
...
使い方: python tmp/delete_expired_0911.py [--apply]
"""
import argparse
import datetime
import json
...
IDS = [524, 1011, 1195, 1263, 2805, 4395, 4466, 5037, 5543, 6608, 7455, 7457]
...
def main():
    ...
    with open(log, 'w', encoding='utf-8') as f:
        ...
        f.write('別エージェントの独立検証（「削除は誤りという前提で」）を通した分＝12件とも反証なし。\n')
