# -*- coding: utf-8 -*-
"""楽天の発売前ハーベスト（tmp/rakuten_presale.json の presale）が、うちに登録済みかを当てる（読むだけ・2026-09-16）。
rakuten_presale_check_0915.py の出力名違い。
...
使い方: python tmp/rakuten_presale_check_0916.py
出力: tmp/rakuten_presale_check_0916.txt
"""
import datetime
import io
import json
...
io.open('tmp/rakuten_presale_check_0916.txt', 'w', encoding='utf-8').write('\n'.join(out) + '\n')
print('\n'.join(out))
