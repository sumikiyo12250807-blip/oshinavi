...
# 🆕2026-09-18 ユーザー「うん　毎日確認お願いします」＝**TIGETの全カテゴリを毎日回す**。
#   それまでは8個（YouTuber/VTuber/歌い手/ボカロ/アイドル/ファンイベント/トークショー/アニメ）だけで、
#   64個中56個を見ていなかった。ぴあに出ない小さなライブは 31(邦楽ポップ／ロック) にいちばん溜まる。
#   親カテゴリ（1音楽・21イベント・22お笑い/演劇/ダンス・24クラシック・25スポーツ・26映画・27アート・28その他）は
#   子を全部含むので回さない＝**葉だけ**を回す（同じイベントを二度読まないため）。
CAT_NAME = {
    # 音楽
    '29': 'アイドル', '30': 'ジャズ／フュージョン', '31': '邦楽ポップ／ロック',
    '32': '邦楽ヒップホップ／レゲエ', '33': '邦楽ソウル／R&B', '34': '邦楽演歌／民謡',
    '35': '邦楽その他', '36': '洋楽ポップ／ロック', '37': '洋楽ヒップホップ／レゲエ',
    '38': '洋楽ソウル／R&B', '39': '洋楽その他', '40': 'アカペラ／合唱',
    '41': 'アニメ／ゲーム／声優', '42': 'フェスティバル(音楽)', '43': '音楽その他',
    '78': 'K-POP', '79': '歌い手', '80': 'ボカロ', '81': 'YouTuber', '84': 'VTuber',
    # イベント
    '44': '脱出／謎解き', '45': 'ショー／ファンイベント', '46': 'トークショー／講演会',
    '47': 'グルメ／ディナーショー', '48': 'ファミリー／子ども向け', '49': 'アニメ／ゲーム',
    '50': 'ファッション／ビューティー', '51': '展示会／博覧会', '52': 'イベントその他',
    '82': '2.5次元',
    # お笑い／演劇／ダンス
    '53': 'お笑い／寄席', '54': '演劇', '55': 'ダンス／パフォーマンス', '56': 'バレエ',
    '57': '朗読／リーディング', '58': 'ミュージカル／ショー', '59': 'フェスティバル(演劇)',
    '60': 'マジック／手品', '61': '演劇その他',
    # クラシック
    '66': 'オーケストラ', '67': '器楽／室内楽', '68': 'オペラ／声楽／合唱',
    '69': '吹奏楽', '70': 'クラシックその他',
    # スポーツ・映画・アート・その他
    '72': '球技', '73': '格闘技', '74': 'スポーツその他',
    '75': '映画', '76': 'アート・ミュージアム', '77': 'その他',
}
# 🚫回さないカテゴリ＝**推しに会いに行く枠ではない**（[[feedback_oshinavi_concept]]）
#   62 ビジネスセミナー／63 技術セミナー／64 ファイナンス・投資セミナー／65 セミナーその他
#   71 ジム／トレーニング（自分が通う教室で、会いに行く相手がいない）
CAT_SKIP = {'62': 'ビジネスセミナー', '63': '技術セミナー', '64': '投資セミナー',
            '65': 'セミナーその他', '71': 'ジム／トレーニング'}
ALL_CATS = ','.join(sorted(CAT_NAME, key=int))
...
def main():
    ...
    ap.add_argument('--cats', default=ALL_CATS,
                    help='既定＝葉カテゴリ全部（2026-09-18からこれ）。8個だけ回したい日は明示する')
